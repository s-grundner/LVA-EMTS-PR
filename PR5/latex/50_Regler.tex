...
\]
Zur bestimmung von $K_P$ und $T_I$ wird die Methode des Stabilitätsrandes nach Ziegler-Nichols verwendet. Hierzu wird der Regler zunächst als reiner P-Regler ausgelegt, indem $C$ überbrückt wird. Die Verstärkung $K_P = -\frac{R_3}{R_1}$ wird dann mit $R_3$ solange erhöht, bis das System gerade noch stabil ist und eine Dauerschwingung aufweist.
