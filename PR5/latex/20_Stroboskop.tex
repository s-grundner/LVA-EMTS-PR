...
Die Verdrahtung des Leistungsverstärkers mit dem Motorprüfstand und den Messgeräten ist in \autoref{fig:strob-rpm-aufbau} dargestellt.
...
Die Lasteinstellung von \SI{50}{\ohm} am Funktionsgenerator dient als Strombegrenzung für die LED aus \devref{pos:strb}. Für die Stellspannug wurden mit dem Labornetzteil \devref{pos:psu} die Werte $u_\text{stell}\in\{0.8, 1.6, 2.4, 3.2, 4.0\}\si{\volt}$ eingestellt und die Ankerspannung $u_A$ mit dem Multimeter \devref{pos:mmeter} überwacht.
