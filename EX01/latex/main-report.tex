...
%% 
\usepackage[TNF,techreport,fancyfonts,equalmargins,fontpath=fonts]{jkureport}
%% 
...
\reversemarginpar\marginnote{\textbf{(#1)}}[5pt]
}
...
\setbottommark{Paul Kronegger (), Simon Grundner (k12136610)}
...
\input{11_Widerstandsmessung1.tex}
\input{12_Widerstandsmessung2.tex}
\input{13_Widerstandsmessung3.tex}
\input{14_Impedanzsmessung.tex}
\input{20_Oszilloskop1.tex}
\input{21_Oszilloskop2.tex}
\input{22_Oszilloskop3.tex}
\input{23_Oszilloskop4.tex}
\input{24_Oszilloskop5.tex}
\input{25_Oszilloskop6.tex}
