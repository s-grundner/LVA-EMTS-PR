...
\begin{enumerate}[label=\textbf{\alph*:}, ref=\alph*, noitemsep]
    \item\label{itm:P1-1} Strom oder Spannungsrichtig messen?
    \item\label{itm:P1-2} Passende Spannung wählen.
    \item\label{itm:P1-3} Kontrollieren, ob der systematische Fehler vernachlässigbar ist.
    \item\label{itm:P1-4} Garantiefehlergrenzen abschätzen.
    \item\label{itm:P1-5} Messung durchführen.
\end{enumerate}
\end{highlightblock}
