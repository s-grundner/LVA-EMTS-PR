...
\cite[p.~183]{SchrüferElmar2022EM:M}.
...
\begin{wrapfigure}[17]{r}{6cm}
    ...
    \includegraphics[width=6cm]{images/11_Aufbau.JPEG}
...
mit
\[
    \frac{\partial R}{\partial U}\Big|_{U=U_V} = \frac{I_A R_{iV}^2}{(-I_A R_{iV} + U_V)^2} =
\]
und
\[
    \frac{\partial R}{\partial I}\Big|_{I=I_A}
\]
\vspace{1mm}