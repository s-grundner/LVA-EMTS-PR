...
Zur Berechnung der Gesamt-Eingangsimpedanz $Z$ betrachtet man das Ersatzbild in \autoref{fig:impedanz-oszi-ac-kopplung}. $C_{AC}$ ist der errechnete Wert aus \autoref{sec:2-3} \autoref{itm:2-P2-3}
...
Die Eingangsimpedanz ist beinahe nur kapazitiv, da der Winkel $\approx \SI{90}{\degree}$ ist. Da jedoch die Impedanz abhängig von $\omega$ ist, würde das Oszilloskop für jede gemessene Frequenz eine unterschiedliche Eingangsimpedanz aufweisen.
