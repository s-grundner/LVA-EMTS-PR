...
\begin{highlightblock}[Messung Impedanzen, Drei-Voltmeter-Methode]
    ...
    \begin{enumerate}[label=\textbf{\alph*:}, ref=\alph*]
        \item\label{itm:P4-1} Frequenz geeignet wählen.
        \item\label{itm:P4-2} Spannungsdreieck zeichnen. Daraus Betrag und Phase ablesen.
        \item\label{itm:P4-3} Ergebnis mit der Rechnung vergleichen.
    \end{enumerate}
\end{highlightblock}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=6cm]{images/14_Aufbau.png}
    \caption{Aufbau der Messung}\label{fig:14-aufbau}
\end{figure}

\marginref{\ref{itm:P4-2}}
...
\marginref{\ref{itm:P4-3}}
Zerlegung in Real- und Imaginärteil: $Z = R + \jmath X$
...
Spannungen stärker auf das Ergebnis aus.
