...
\begin{figure}[h]
	\centering
	\includegraphics[width=6cm]{images/21_AC-DC-oszillogramm.jpg}
...
\begin{figure}[h]
	\begin{minipage}[t]{.48\textwidth}
		\centering
		\includegraphics[height=4.1cm]{images/Spektrum-Squarewave.jpg}
		\caption{Spektrum eines Rechtecksignals}
	\end{minipage}\hfill
	\begin{minipage}[t]{.48\textwidth}
		\centering
		\includegraphics[height=4.1cm]{images/HochpassAbs.png}
