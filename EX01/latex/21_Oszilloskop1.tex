...
\begin{figure}[h]
	\centering
	\includegraphics[width=7cm]{21_Aufbau.png}
...
Am Bildschirm des Oszilloskops (\autoref{fig:oszi-recktecksignal-beider-kanaele}) sind nun die beiden Rechtecksignale zu sehen.

\begin{figure}[h]
	\centering
	\includegraphics[width=5.5cm]{21_AC-DC-oszillogramm.jpg}
	\caption{Oszillogramm des Rechtecksignals beider Kanäle}\label{fig:oszi-recktecksignal-beider-kanaele}
\end{figure}
...
\begin{figure}[h]
	\begin{minipage}[t]{.48\textwidth}
		\centering
		\includegraphics[height=4cm]{Spektrum-Squarewave.jpg}
		\caption{Spektrum eines Rechtecksignals}
	\end{minipage}\hfill
	\begin{minipage}[t]{.48\textwidth}
		\centering
		\includegraphics[height=4cm]{HochpassAbs.png}
